...
function Banner() {
  ...
  return (
    ...
    <AddModal onClose={handleAddOnClose} visible={addModal} reload={fetchData}/>
    <EditModal onClose={handleEditOnClose} visible={editModal} reload={fetchData} data={name} id={id}/>
  </div>
  )
}
