...
const navigate = useNavigate()
  return (
    <div className="flex justify-center">
      <div className="flex w-3/4 h-96 mr-32 ml-32 my-3 rounded-lg border shadow-xl text-gray-500">
        <div className="w-72 h-64 m-10 ">
          <img
        ...
        <div className="flex flex-col font-Lora mt-10">
